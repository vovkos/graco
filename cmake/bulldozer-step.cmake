...
add_bulldozer_step
	...
	set (_FRAME_PATH  "${BULLDOZER_FRAME_DIR}/${_FRAME_FILE_NAME}")
...
add_bulldozer_double_step
	...
	set (_INPUT_PATH    "${CMAKE_CURRENT_SOURCE_DIR}/${_INPUT_FILE_NAME}")
	set (_FRAME_PATH_1  "${BULLDOZER_FRAME_DIR}/${_FRAME_FILE_NAME_1}")
	set (_FRAME_PATH_2  "${BULLDOZER_FRAME_DIR}/${_FRAME_FILE_NAME_2}")
